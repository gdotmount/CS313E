...
def groupSumClump(start, nums, target):
    ...
    for i in range(start + 1, len(nums)):
        if nums[i] == nums[start]:
            ...
            break
    return (groupSumClump(start + rec, nums, target - nums[start] * rec)
            or groupSumClump(start + rec, nums, target))
...
# (No loops needed.)
def splitArray(nums):
    return splitArrayHelper(nums, [])


def splitArrayHelper(a, b, i=0):
    if i == len(a):
        return sum(a) == sum(b)
    else:
        c = b[:]
        ...
        d = a[:]
        d.pop(i)
        return (splitArrayHelper(d, b, i)
                or splitArrayHelper(a, c, i + 1))
...
def splitOdd10(nums):
    return splitOdd10Helper(nums, [])


def splitOdd10Helper(a, b, i=0):
    if i == len(a):
        return sum(a) % 10 == 0 and sum(b) % 2 != 0
    else:
        c = b[:]
        b.append(a[i])
        d = a[:]
        d.pop(i)
        return (splitOdd10Helper(d, b, i)
                or splitOdd10Helper(a, c, i + 1))
...
def split53(nums):
    return split53Helper(nums, [])


def split53Helper(a, b, i=0):
    if i == len(a):
        return sum(a) == sum(b)
    elif a[i] % 5 == 0:
        b.append(a[i])
        a.pop(i)
        return split53Helper(a, b, i)
    elif a[i] % 3 == 0:
        return split53Helper(a, b, i + 1)
    else:
        c = b[:]
        b.append(a[i])
        d = a[:]
        d.pop(i)
        return (split53Helper(d, b, i)
                or split53Helper(a, c, i + 1))
